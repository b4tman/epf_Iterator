...
Функция __СимволыВСтроке(Знач Стр) Экспорт
    Результат = Новый Массив;
    ...
    Возврат Результат;
КонецФункции
Функция __МассивПоДиапазонуЧисел(Число_С, Число_По) Экспорт
    Результат = Новый Массив;
    ...
    Возврат Результат;
КонецФункции
Функция __ЭтоКоллекция(ЧтоТо) Экспорт
    Результат = Ложь;
    ...
    Возврат Результат;
КонецФункции
Функция __ОбходДерева(Дерево, Знач КодПолученияСтрок = "", Знач ВШирину = Ложь) Экспорт
    Результат = Новый Массив;
